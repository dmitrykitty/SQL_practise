...
(
    ...
    company_id INT REFERENCES company_2(id), --referencja do innej tablicy
    salary     INT,
...
INSERT INTO employee (first_name, last_name, salary, company_id) --TERAZ ID TWORZONE AUTOMATYCZNIE OD 1
VALUES ('Ivan', 'Petrov', 2000, 1),
       ('Ivan', 'Nikitin', 750, 2),
       ('Kristina', 'Mironenko', 5000, 3),
       ('Pavel', 'Kaplica', 666, NULL);
...
FROM employee
WHERE salary > 1500
UNION  --połaczenie dwoch polecen (UNION_ALL zachowuje powtarające się  linijki)
SELECT first_name, salary
FROM employee
