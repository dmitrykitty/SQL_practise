...
DROP SCHEMA IF EXISTS albumy CASCADE;
...
CREATE SEQUENCE albumy.wykonawcy_idwykonawcy_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START WITH 1
...
CREATE TABLE albumy.wykonawcy(
	idwykonawcy integer NOT NULL DEFAULT nextval('albumy.wykonawcy_idwykonawcy_seq'::regclass),
...
CREATE SEQUENCE albumy.utwory_idutworu_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START WITH 1
...
CREATE TABLE albumy.utwory(
	idutworu integer NOT NULL DEFAULT nextval('albumy.utwory_idutworu_seq'::regclass),
...
CREATE SEQUENCE albumy.playlisty_idplaylisty_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START WITH 1
...
CREATE TABLE albumy.playlisty(
	idplaylisty integer NOT NULL DEFAULT nextval('albumy.playlisty_idplaylisty_seq'::regclass),
...
CREATE SEQUENCE albumy.albumy_idalbumu_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START WITH 1
...
CREATE TABLE albumy.albumy(
	idalbumu integer NOT NULL DEFAULT nextval('albumy.albumy_idalbumu_seq'::regclass),
...
CREATE SEQUENCE albumy.gatunki_idgatunku_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START WITH 1
...
CREATE SEQUENCE albumy.klienci_idklienta_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START WITH 1
...
CREATE TABLE albumy.klienci(
	idklienta integer NOT NULL DEFAULT nextval('albumy.klienci_idklienta_seq'::regclass),
...
CREATE UNIQUE INDEX klienci_login_uindex ON albumy.klienci
USING btree
(
	login
)
...
ALTER TABLE albumy.utwory ADD CONSTRAINT utwory_albumy_idalbumu_fk FOREIGN KEY (idalbumu)
REFERENCES albumy.albumy (idalbumu) MATCH SIMPLE
...
ALTER TABLE albumy.playlisty ADD CONSTRAINT playlisty_klienci_idklienta_fk FOREIGN KEY (idklienta)
REFERENCES albumy.klienci (idklienta) MATCH SIMPLE
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE albumy.albumy ADD CONSTRAINT albumy_wykonawcy_idwykonawcy_fk FOREIGN KEY (idwykonawcy)
REFERENCES albumy.wykonawcy (idwykonawcy) MATCH SIMPLE
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE albumy.zawartosc ADD CONSTRAINT zawartosc_playlisty_idplaylisty_fk FOREIGN KEY (idplaylisty)
REFERENCES albumy.playlisty (idplaylisty) MATCH SIMPLE
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE albumy.zawartosc ADD CONSTRAINT zawartosc_utwory_idutworu_fk FOREIGN KEY (idutworu)
REFERENCES albumy.utwory (idutworu) MATCH SIMPLE
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE albumy.oceny ADD CONSTRAINT oceny_klienci_idklienta_fk FOREIGN KEY (idklienta)
REFERENCES albumy.klienci (idklienta) MATCH SIMPLE
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE albumy.oceny ADD CONSTRAINT oceny_utwory_idutworu_fk FOREIGN KEY (idutworu)
REFERENCES albumy.utwory (idutworu) MATCH SIMPLE
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
